...
function init() {
    ...
    for (var element of arry) {
        var child = createElement(element.tagName, width, parent, "child", element.backColor, null);
    ...
    footer.innerHTML = "Müştəri xidmətləri: 012 404 48 88";
